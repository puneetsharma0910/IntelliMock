...
const Login = ({ setCurrentPage }) => {
  ...
  return (
    <div className="w-[70vw] max-w-md md:w-[33vw] p-8 bg-white/80 backdrop-blur-md rounded-2xl shadow-2xl flex flex-col justify-center border border-amber-100/60 glass-card animate-fade-in">
      <h3 className="text-3xl font-extrabold mb-1 animate-text-shine bg-gradient-to-r from-[#FF9324] via-[#e99a4b] to-[#FF9324] bg-clip-text text-transparent">
        Welcome Back
      </h3>
      <p className="text-sm text-amber-700 mb-8">
        Please enter your details to log in
      ...
      <form onSubmit={handleLogin} className="space-y-6">
        ...
        <button
          type="submit"
          className={`w-full py-3 rounded-full text-white font-semibold text-lg transition duration-300 cta-glow ${
            isLoading
              ? "bg-amber-500/70 cursor-not-allowed"
