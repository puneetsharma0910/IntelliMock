...
// const conceptExplainPrompt = (numberOfQuestions) => (
//     `
...
const conceptExplainPrompt = (question) => (
  `
  You are a seasoned interviewer. Your task is to explain the following technical concept clearly and concisely.

  Concept: ${question}

  If needed, include small code examples to clarify the explanation.
  Keep formatting very clean.
  Return the result as a valid JSON object in the following format:

  {
    "title": "Short title or summary of the concept",
